...
$resolutions   = array(1900, 992, 767, 480); // the resolution break-points to use (screen widths, in pixels)
$cache_path    = "projects/canvas/app/webroot/ai-cache"; // where to store the generated re-sized images. Specify from your document root!
...
$source_file = str_replace("/projects/canvas/", "/projects/canvas/app/webroot/", $source_file);
$resolution     = FALSE;
