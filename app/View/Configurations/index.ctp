<div class="configurations index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('piwik_path'); ?></th>
			<th><?php echo $this->Paginator->sort('piwik_site_id'); ?></th>
			<th><?php echo $this->Paginator->sort('site_offline'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($configuration['Configuration']['piwik_path']); ?>&nbsp;</td>
		<td><?php echo h($configuration['Configuration']['piwik_site_id']); ?>&nbsp;</td>
		<td><?php echo h($configuration['Configuration']['site_offline']); ?>&nbsp;</td>
		<td><?php echo h($configuration['Configuration']['site_title']); ?>&nbsp;</td>
		<td class="actions">
