							...
							<div class="blog-item blog-item-2">
								<div class="blog-img">
									...
									<div class="social-ul social-ul-2 post-social">
										<ul>
											<li class="social-facebook" data-url="http://test.electropocas.pt/OG/share/<?php echo $noticia['Noticia']['id'] ?>"><a href="#"><i class="fa fa-facebook"></i></a></li>
											<li class="social-twitter" data-url="http://test.electropocas.pt/Noticia/<?php echo $noticia['Noticia']['hashtag'] ?>"><a href="#"><i class="fa fa-twitter"></i></a></li>
											<li class="social-google" data-url="http://test.electropocas.pt/OG/share/<?php echo $noticia['Noticia']['id'] ?>"><a href="#"><i class="fa fa-google-plus"></i></a></li>
										</ul>
									</div><!-- End post-social -->
								</div><!-- End blog-item -->
